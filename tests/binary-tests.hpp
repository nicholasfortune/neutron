...
namespace binary
{
	...
	inline bool insert_bytes()
	{
		...
		neutron::binary::insert_bytes(test_file_name, 0, 0, reinterpret_cast<char *>(data.data()), data.size() * sizeof(uint32_t));
		...
		neutron::binary::insert_bytes(test_file_name, sizeof(uint32_t), sizeof(uint32_t), reinterpret_cast<char *>(to_overwrite.data()), to_overwrite.size() * sizeof(uint32_t));
		...
		neutron::binary::insert_bytes(test_file_name, 4 * sizeof(uint32_t), 0, reinterpret_cast<char *>(to_append.data()), to_append.size() * sizeof(uint32_t));
		file.seekg(0, std::ios::beg);
		...
		neutron::binary::insert_bytes(test_file_name, sizeof(uint32_t), 4 * sizeof(uint32_t), reinterpret_cast<char *>(to_smaller_overwrite.data()), to_smaller_overwrite.size() * sizeof(uint32_t));
		file.seekg(0, std::ios::beg);
		...
		neutron::binary::insert_bytes(test_file_name, sizeof(uint32_t), 0, reinterpret_cast<char *>(to_insert.data()), to_insert.size() * sizeof(uint32_t));
		file.seekg(0, std::ios::beg);
	...
	inline bool overwrite_config()
	{
		...
		neutron::binary::overwrite_config(test_file_name, data);
